...
public class AssetTypeEntitySeeder : EntitySeeder<AssetType>
{
    ...
    public override async Task Development()
    {
        ...
        await _repository.CreateAsync(default,
            ...
            new AssetType() { Id = "6602b5508836f41c710e02ee", Name = "Laptop", ShortName = "LAP", Icon = "Laptop" },
            new AssetType() { Id = "6602b5508836f41c710e02ef", Name = "Chair", ShortName = "CHR", Icon = "Office chairs" },
