...
public class AssetTypeEntitySeeder : EntitySeeder<AssetType>
{
    ...
    public override async Task Development()
    {
        ...
        {
            new Properties { Label = "Model", Value = "" }, new Properties { Label = "Size, Inch", Value = "24" }
        };

        var chairProperties = new List<Properties>
        {
            new Properties { Label = "Model", Value = "" }, new Properties { Label = "Color", Value = "" },
        };

        var otherProperties = new List<Properties> { new Properties { Label = "Model", Value = "" }, };

        await _repository.CreateAsync(default,
            new AssetType()
            {
                Id = "6602b5508836f41c710e02ed",
                Slug = "pc",
                Name = "PC",
                ShortName = "PC",
            ...
            new AssetType()
            {
                Id = "6602b5508836f41c710e02ee",
                Slug = "laptop",
                Name = "Laptop",
                ShortName = "LPT",
                Properties = laptopProperties,
                Icon = "Laptop"
            },
            new AssetType()
            {
                Id = "6602b5508836f41c710e02ef",
                Slug = "chair",
                Name = "Chair",
                ShortName = "CHR",
                Properties = chairProperties,
                Icon = "Chair"
            },
            new AssetType()
            {
                Id = "6602b5508836f41c710e02f0",
                Slug = "monitor",
                Name = "Monitor",
                ShortName = "MTR",
