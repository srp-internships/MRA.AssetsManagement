...
public class AssetEntitySeeder : EntitySeeder<Asset>
{
    ...
    public override async Task Development()
    {
        ...
        await _repository.CreateAsync(default, [
            ...
            new Asset { Id = "660510ad00baa1f0e906225e", Name = "Lenovo", AssetTypeId = "6602b5508836f41c710e02ee" },
            ...
            new Asset { Id = "6605130500baa1f0e906232a", Name = "Dafne", AssetTypeId = "6602b5508836f41c710e02ef" }
        ]);
    }
}